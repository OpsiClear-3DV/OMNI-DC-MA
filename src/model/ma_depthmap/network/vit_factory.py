...
# Absolute path to the `network/` package directory (this file's parent).
# Vendored in-tree: lets torch.hub.load resolve without depending on CWD,
# which the upstream code assumed.
_NETWORK_DIR = str(Path(__file__).resolve().parent)
